...
/// The compression algorithm used to compress and decompress records in streamfy batches
...
impl From<streamfy_types::compression::Compression> for Compression {
    fn from(fcc: streamfy_types::compression::Compression) -> Self {
        use streamfy_types::compression::Compression as CompressionType;
...
mod tests {
    ...
    #[test]
    fn converts_from_streamfy_compression() {
        use streamfy_types::compression::Compression as CompressionType;
