...
fn impl_test_case_macro(opt_struct: &syn::DeriveInput) -> TokenStream {
    ...
    let token_stream = quote! {
        ...
        pub struct #test_case_struct_ident {
            pub environment: streamfy_test_util::test_meta::environment::EnvironmentSetup,
            pub option: #options_struct_name_ident,
        }

        impl From<streamfy_test_util::test_meta::TestCase> for #test_case_struct_ident {
            fn from(test_case: streamfy_test_util::test_meta::TestCase) -> Self {
        ...
        impl streamfy_test_util::test_meta::TestOption for #options_struct_name_ident {
...
pub fn streamfy_test_case_derive(input: TokenStream) -> TokenStream {
