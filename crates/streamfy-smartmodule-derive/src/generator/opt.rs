...
pub fn impl_smart_opt(input: DeriveInput) -> syn::Result<TokenStream> {
    ...
    let token_stream = quote! {
        impl #impl_generics std::convert::TryFrom<streamfy_smartmodule::dataplane::smartmodule::SmartModuleExtraParams
        > for #name #ty_generics #where_clause {
            type Error =  String;
                fn  try_from(params: streamfy_smartmodule::dataplane::smartmodule::SmartModuleExtraParams) -> ::std::result::Result<Self, Self::Error>{
