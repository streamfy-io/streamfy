...
use streamfy_test_util::test_meta::environment::EnvironmentSetup;
use streamfy_test_util::test_meta::{TestOption, TestCase};
use streamfy_test_util::async_process;

use streamfy_cli::TableFormatConfig;
...
#[command(name = "Streamfy Smoke Test")]
...
#[streamfy_test(topic = "test")]
pub fn smoke(mut test_driver: StreamfyTestDriver, mut test_case: TestCase) {
