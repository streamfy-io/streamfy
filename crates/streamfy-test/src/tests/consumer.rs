...
use streamfy::consumer::{ConsumerConfigExtBuilder, Record};
...
#[command(name = "Streamfy Consumer Test")]
...
where
    //S: Stream<Item = Result<Record, StreamfyError>> + std::marker::Unpin,
...
#[streamfy_test(name = "consumer", topic = "consumer-test")]
