...
use streamfy::TopicProducerPool;
use futures_lite::StreamExt;
use tracing::debug;
use clap::Parser;

use streamfy::{Offset, TopicProducerConfigBuilder, StreamfyAdmin};
...
#[command(name = "Streamfy Batching Test")]
pub struct BatchingTestOption {}

#[streamfy_test(topic = "batching", async)]
