...
#[command(name = "Streamfy Longevity Test")]
...
#[streamfy_test(name = "generator", topic = "generated", timeout = false)]
pub fn data_generator(test_driver: StreamfyTestDriver, test_case: TestCase) {
