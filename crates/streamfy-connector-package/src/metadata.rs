...
pub struct ConnectorPackage {
    ...
    pub streamfy: StreamfySemVersion,
    ...
    fn default() -> Self {
        Self {
            ...
            package: ConnectorPackage {
                ...
                version: StreamfySemVersion::parse("0.0.0").expect("invalid SemVer"),
                streamfy: StreamfySemVersion::parse("0.0.0").expect("invalid SemVer"),
                api_version: StreamfySemVersion::parse("0.0.0").expect("invalid SemVer"),
        ...
        assert_eq!(
            ...
            ConnectorMetadata {
                ...
                package: ConnectorPackage {
                    name: "p_name".into(),
                    group: "p_group".into(),
                    version: StreamfySemVersion::parse("0.1.1").unwrap(),
                    streamfy: StreamfySemVersion::parse("0.1.2").unwrap(),
                    api_version: StreamfySemVersion::parse("0.1.3").unwrap(),
...
mod tests {
    ...
    fn test_validate_deployment() {
        ...
        assert_eq!(
            ...
            "deployment image in metadata: 'streamfy/streamfy-connect-http_sink:latest' mismatches image in config: 'streamfy/streamfy-connect-http_source:latest'"
        );
    }
    ...
    fn test_validate_config() {
        ...
        let metadata = ConnectorMetadata {
            direction: Direction::source(),
            deployment: Deployment::from_image_name("streamfy/streamfy-connect-http-source:latest"),
            custom_config: CustomConfigSchema::new(
                [("prop1", Type::Integer(Default::default()))],
                ["prop1"],
            ),
