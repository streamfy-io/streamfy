...
pub use streamfy_smartmodule_derive::{smartmodule, SmartOpt};
...
pub use streamfy_protocol::record::{Offset, Record, RecordData};
...
pub mod dataplane {
    pub mod smartmodule {
        pub use streamfy_protocol::link::smartmodule::*;
    ...
    pub mod record {
        pub use streamfy_protocol::record::*;
    }
}
