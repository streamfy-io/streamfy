...
use streamfy_protocol::record::{Offset, Record};
use streamfy_protocol::types::Timestamp;
...
pub struct SmartModuleInput {
    ...
    #[deprecated]
    #[streamfy(max_version = 22)]
    params: SmartModuleExtraParams,
    #[streamfy(min_version = 16, max_version = 22)]
    join_record: Vec<u8>,
    /// The base timestamp of this batch of records
    #[streamfy(min_version = 22)]
...
impl SmartModuleInput {
    ...
    #[deprecated = "use SmartModuleRecord instead. Read more here: https://www.streamfy.io/smartmodules/smdk/smartmodulerecord/."]
