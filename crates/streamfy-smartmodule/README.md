...
of Streamfy streams to consumers. The currently supported SmartModule
...
[the SmartModule template]: https://github.com/streamfy/streamfy-smartmodule-template

```toml
[package]
name = "streamfy-wasm-filter"
version = "0.1.0"
...
```rust
use streamfy_smartmodule::{smartmodule, SmartModuleRecord, Result};
...
```rust
use streamfy_smartmodule::{smartmodule, SmartModuleRecord, RecordData, Result};
...
```rust
use streamfy_smartmodule::{smartmodule, Result, SmartModuleRecord, RecordData};
...
for inclusion in Streamfy by you, shall be licensed as Apache, without any additional
terms or conditions.
