...
use streamfy_spu_schema::produce::DefaultProduceRequest;
use streamfy_spu_schema::fetch::DefaultFetchRequest;
use streamfy_protocol::link::versions::ApiVersionKey;
use streamfy_spu_schema::server::SpuServerApiKey;
...
use streamfy_spu_schema::server::update_offset::UpdateOffsetsRequest;
use streamfy_spu_schema::{ApiVersionsRequest, ApiVersionsResponse};
...
pub async fn handle_api_version_request(
    ...
    response.api_keys.push(make_version_key(
        ...
        0,
        // Client version is empty in Streamfy <= 0.9.12
