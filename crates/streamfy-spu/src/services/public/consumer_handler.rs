...
use streamfy_spu_schema::server::consumer_offset::DeleteConsumerOffsetRequest;
use streamfy_spu_schema::server::consumer_offset::DeleteConsumerOffsetResponse;
use streamfy_spu_schema::server::consumer_offset::FetchConsumerOffsetsRequest;
use streamfy_spu_schema::server::consumer_offset::FetchConsumerOffsetsResponse;
use streamfy_spu_schema::server::consumer_offset::UpdateConsumerOffsetRequest;
use streamfy_spu_schema::server::consumer_offset::UpdateConsumerOffsetResponse;
use streamfy_spu_schema::server::consumer_offset::ConsumerOffset as ConsumerOffsetResponse;
