...
use streamfy_types::defaults::SPU_PRIVATE_PORT;
use streamfy_types::defaults::SC_PRIVATE_PORT;
use streamfy_types::defaults::SPU_LOG_BASE_DIR;
use streamfy_types::defaults::SPU_LOG_SIZE;
use streamfy_types::defaults::SPU_LOG_INDEX_MAX_BYTES;
use streamfy_types::defaults::SPU_LOG_INDEX_MAX_INTERVAL_BYTES;
use streamfy_types::defaults::SPU_LOG_SEGMENT_MAX_BYTES;
use streamfy_types::defaults::SPU_RETRY_SC_TIMEOUT_MS;
use streamfy_types::defaults::SPU_SMARTENGINE_STORE_MAX_BYTES;

// environment variables

use streamfy_types::defaults::SPU_MIN_IN_SYNC_REPLICAS;
use streamfy_types::defaults::FLV_LOG_BASE_DIR;
use streamfy_types::defaults::FLV_LOG_SIZE;
...
impl Default for SpuConfig {
    fn default() -> Self {
        Self {
            ...
            log: Log::default(),
            peer_max_bytes: streamfy_storage::FileReplica::PREFER_MAX_LEN,
