...
use anyhow::Result;
use streamfy_kv_storage::{Log, LogBasedKVStorage};
...
/// [`Log`] implementation that enables using [`streamfy_kv_storage::KVStorage`] on top of [`LeaderReplicaState`].
...
mod tests {
    ...
    use streamfy_kv_storage::KVStorage;
