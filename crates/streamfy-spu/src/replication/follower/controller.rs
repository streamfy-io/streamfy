...
mod inner {
    ...
    use streamfy_socket::StreamfySink;
    ...
    impl FollowGroupController {
        ...
        async fn sync_with_leader(&mut self, socket: StreamfySocket) -> Result<bool, SocketError> {
        ...
        async fn create_socket_to_leader(
            ...
            loop {
                ...
                match StreamfySocket::connect(&leader_endpoint).await {
                    Ok(mut socket) => {
