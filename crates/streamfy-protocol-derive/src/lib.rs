...
#[proc_macro_derive(Decoder, attributes(varint, trace, streamfy))]
pub fn streamfy_decode(tokens: TokenStream) -> TokenStream {
...
#[proc_macro_derive(Encoder, attributes(varint, trace, streamfy))]
pub fn streamfy_encode(tokens: TokenStream) -> TokenStream {
    let input = parse_macro_input![tokens as ast::DeriveItem];
...
#[proc_macro]
pub fn streamfy_api(tokens: TokenStream) -> TokenStream {
...
#[proc_macro_derive(RequestApi, attributes(varint, streamfy))]
pub fn streamfy_request(tokens: TokenStream) -> TokenStream {
    let inputs = parse_macro_input![tokens as syn::DeriveInput];
...
#[proc_macro_derive(StreamfyDefault, attributes(streamfy))]
pub fn streamfy_default(tokens: TokenStream) -> TokenStream {
    let input = parse_macro_input![tokens as ast::DeriveItem];
