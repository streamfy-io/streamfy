mod test {
    ...
    use streamfy_protocol::{Decoder, Encoder, StreamfyDefault, RequestApi};

    #[derive(Encoder, Decoder, StreamfyDefault, RequestApi, Debug)]
    #[streamfy(
        api_min_version = 5,
        api_max_version = 6,
        api_key = 10,
    ...
    pub struct TestRequest {
        ...
        #[streamfy(min_version = 1, max_version = 1)]
        pub value2: i8,

        #[streamfy(min_version = 1, default = "-1")]
        pub value3: i8,
    }
    ...
    pub struct MyAddr {
        ...
        #[streamfy(min_version = 4, max_version = 9)]
        pub addr2: i8,
    }
