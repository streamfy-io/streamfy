...
use streamfy_types::{PartitionId, Timestamp};
...
///
/// [the Producer API]: https://docs.rs/streamfy/producer/TopicProducer::send
...
mod test {
    ...
    //
    // ```rust
    // use streamfy_dataplane_protocol::record::{Record, DefaultAsyncBuffer};
