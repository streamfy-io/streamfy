# Contributing to streamfy-protocol
...
- Fork the `streamfy-protocol` repository to your GitHub Account.
...
This project is licensed under the [Apache license](LICENSE). Unless you explicitly state otherwise, any contribution intentionally submitted for inclusion in Streamfy by you, shall be licensed as Apache, without any additional terms or conditions.
