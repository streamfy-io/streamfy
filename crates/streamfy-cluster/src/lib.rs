//! Functionality for installing, managing, and deleting Streamfy clusters.
//!
//! The primary use of this crate is to install Streamfy clusters on
//! Kubernetes using a [`ClusterInstaller`], which provides a fluid
//! interface for cluster specification.
//!
//! # Example
//!
//! To install a basic Streamfy cluster, just do the following:
//!
//! ```
...
//! installer.install_streamfy().await?;
//! # Ok(())
//! # }
//! ```
//!
...
pub use delete::*;
pub use streamfy::config as streamfy_config;
pub use streamfy_extension_common::installation::InstallationType;
...
mod common {
    ...
    use anyhow::Result;
    use streamfy::config::{TlsPaths, TlsConfig};
    use serde::{Serialize, Deserialize};

    /// The result of a successful startup of a Streamfy cluster
    ///
    ...
    impl StartStatus {
        /// The address where the newly-started Streamfy cluster lives
