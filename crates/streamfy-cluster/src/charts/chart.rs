...
const APP_CHART_NAME: &str = "streamfy";

/// Configuration options for installing Streamfy system charts
...
/// Installs or upgrades the Streamfy system charts
#[derive(Debug)]
...
impl ChartInstaller {
    ...
    /// Install the Streamfy System chart on the configured cluster
    pub fn install(&self) -> Result<()> {
        self.process(false)
    }

    /// Upgrade the Streamfy System chart on the configured cluster
