...
/// Uninstalls different flavors of streamfy
...
impl ClusterUninstaller {
    ...
    async fn uninstall_k8(&self) -> Result<()> {
        ...
        pb.println("Uninstalled streamfy kubernetes components");
        pb.finish_and_clear();
    ...
    async fn uninstall_sys(&self) -> Result<()> {
        ...
        self.helm_client
            ...
            .map_err(UninstallError::HelmError)?;
        debug!("streamfy sys chart has been uninstalled");

        pb.set_message("Streamfy System chart has been uninstalled");
        pb.finish_and_clear();
    ...
    async fn uninstall_local(&self) -> Result<()> {
        ...
        // delete streamfy file
        debug!("Removing streamfy directory");
        ...
        pb.println("Uninstalled streamfy local components");
        pb.finish_and_clear();
    ...
    async fn cleanup_k8(&self) -> Result<()> {
        ...
        // delete secrets
        let _ = self.remove_secrets("streamfy-ca");
        let _ = self.remove_secrets("streamfy-tls");
    ...
    async fn remove_finalizers_for_partitions(&self, namespace: &str) -> Result<()> {
        ...
        use streamfy_controlplane_metadata::store::k8::K8ExtendedSpec;
