...
pub const PRODUCT_NAME: &str = "streamfy";

// Streamfy
pub const STREAMFY_MAX_SIZE_TOPIC_NAME: u8 = 255;

// Client
pub const STREAMFY_CLIENT_MAX_FETCH_BYTES: i32 = 1_048_588;

// SPU/SC Server Path
pub const SERVER_CONFIG_BASE_PATH: &str = "/etc";
pub const SERVER_CONFIG_DIR: &str = "streamfy";
...
pub const SPU_CREDENTIALS_FILE: &str = "/etc/streamfy/.credentials/token_secret";
pub const SPU_RETRY_SC_TIMEOUT_MS: u16 = 3000;
pub const SPU_MIN_IN_SYNC_REPLICAS: u16 = 1;
pub const SPU_LOG_BASE_DIR: &str = "/var/lib/streamfy/data";
...
pub const SPU_MONITORING_UNIX_SOCKET: &str = "/tmp/streamfy-spu.sock";
...
pub const TLS_CLIENT_SECRET_NAME: &str = "streamfy-client-tls";
pub const TLS_SERVER_SECRET_NAME: &str = "streamfy-tls";

// Env
pub const FLV_STREAMFY_HOME: &str = "STREAMFY_HOME";
