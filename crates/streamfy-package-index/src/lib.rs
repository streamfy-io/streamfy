//! Data structures and domain logic for reading the Streamfy Package Index.
//!
//! This crate is used by the plugin installer and the self-updater. It
//! is capable of reading the index file in the Streamfy Package Registry
...
//! e.g. via `streamfy install streamfy-cloud`, and to give the CLI visibility
...
pub const INDEX_HOST: &str = "https://packages.streamfy.io/";
pub const INDEX_LOCATION: &str = "https://packages.streamfy.io/v1/";
...
impl IndexMetadata {
    ...
    /// greater than this version of the `streamfy-package-index` crate.
...
#[derive(Debug, Serialize, Deserialize)]
pub struct StreamfyIndex {
    /// Metadata about the Streamfy Index itself
    #[serde(alias = "index")]
