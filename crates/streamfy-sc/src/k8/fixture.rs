...
use streamfy_stream_dispatcher::metadata::SharedClient;
use streamfy_stream_dispatcher::store::StoreContext;
use tracing::debug;
...
use streamfy_controlplane_metadata::store::{LocalStore, MetadataStoreObject};
use streamfy_controlplane_metadata::store::k8::K8MetaItem;
use streamfy_stream_model::k8_types::core::namespace::NamespaceSpec;
use streamfy_stream_model::k8_types::{InputK8Obj, InputObjectMeta, K8Obj};
...
// apiVersion: v1
// data:
//   image: streamfy/streamfy:b9281e320266e295e75200d10b769967e23d3ed2
// lbServiceAnnotations: '{"streamfy.io/ingress-address":"192.168.208.2"}'
// podSecurityContext: '{}'
...
impl TestEnv {
    ...
    pub async fn create_global_ctx(
        ...
        let config_map = ScConfigMetadata::with_spec("streamfy", ScK8Config::default());
        ...
        assert!(config_ctx.store().value("streamfy").await.is_some());
