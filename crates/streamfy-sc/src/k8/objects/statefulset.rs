...
pub use streamfy_stream_model::k8_types::app::stateful::StatefulSetSpec as K8StatefulSetSpec;
pub use streamfy_stream_model::k8_types::app::stateful::StatefulSetStatus as K8StatefulSetStatus;
