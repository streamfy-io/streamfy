...
use streamfy_stream_model::k8_types::core::service::{LoadBalancerIngress, LoadBalancerType};
...
fn get_ingress_from_service(
    ...
    // If empty, the use `streamfy.io/ingress-address` annotation to set an external address for SPU
