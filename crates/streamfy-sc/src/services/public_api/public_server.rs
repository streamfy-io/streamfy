...
//!
//! Public service API allows 3rd party systems to invoke operations on Streamfy
...
use streamfy_service::api_loop;
use streamfy_service::call_service;
use streamfy_socket::StreamfySocket;
use streamfy_service::StreamfyService;
use streamfy_sc_schema::AdminPublicApiKey;
use streamfy_sc_schema::AdminPublicDecodedRequest;
...
#[async_trait]
impl<A, C> StreamfyService for PublicService<A, C>
where
