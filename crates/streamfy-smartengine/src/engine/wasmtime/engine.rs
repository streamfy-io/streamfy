...
use anyhow::Result;
use streamfy_smartmodule::Record;
use tracing::debug;
use wasmtime::{Engine, Module};

use streamfy_smartmodule::dataplane::smartmodule::{SmartModuleInput, SmartModuleOutput};
...
// tracing target
const TTGT_SMARTMODULE_CALL: &str = "streamfy_smartengine::smartmodule::call";
...
mod chaining_test {
    ...
    use streamfy_protocol::link::smartmodule::SmartModuleLookbackRuntimeError;
    ...
    const SM_FILTER_INIT: &str = "streamfy_smartmodule_filter_init";
    const SM_MAP: &str = "streamfy_smartmodule_map";
    const SM_FILTER_LOOK_BACK: &str = "streamfy_smartmodule_filter_lookback";
    ...
    const SM_AGGEGRATE: &str = "streamfy_smartmodule_aggregate";
    ...
    fn test_chain_filter_look_back() {
        ...
        // when
        streamfy_future::task::run_block_on(chain.look_back(|lookback| {
        ...
        let module_metrics = metrics
            .get("streamfy_smartmodule_filter_lookback")
    ...
    fn test_chain_filter_look_back_error_propagated() {
        ...
        // when
        let res = streamfy_future::task::run_block_on(chain.look_back(|lookback| {
            assert_eq!(lookback, Lookback::Last(1));
    ...
    fn test_look_back_unsufficient_memory() {
        ...
        // when
        let res = streamfy_future::task::run_block_on(chain.look_back(|_| {
