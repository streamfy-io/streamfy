...
impl From<Lookback> for streamfy_smartmodule::dataplane::smartmodule::Lookback {
...
mod tests {
    ...
    fn test_read_from_file() {
        ...
        assert_eq!(
            ...
            TransformationConfig {
                transforms: vec![
                    TransformationStep {
                        uses: "streamfy/jolt@0.4.1".to_string(),
                    ...
                    TransformationStep {
                        uses: "streamfy/json-sql@0.2.1".to_string(),
    ...
    fn test_from_vec() {
        //given
        let vec = vec![
            r#"{"uses":"streamfy/jolt@0.4.1","invoke":"insert","with":{"spec":"[{\"operation\":\"remove\",\"spec\":{\"length\":\"\"}}]"}}"#,
            r#"{"uses":"streamfy/json-sql@0.2.1","invoke":"insert","with":{"mapping":"{\"table\":\"topic_message_demo\",\"map-columns\":{\"fact\":{\"json-key\":\"fact\",\"value\":{\"type\":\"text\",\"required\":true}},\"record\":{\"json-key\":\"$\",\"value\":{\"type\":\"jsonb\",\"required\":true}}}}"}}"#,
        ];
        ...
        assert_eq!(config.transforms[0].uses, "streamfy/jolt@0.4.1");
        assert_eq!(
        ...
        assert_eq!(config.transforms[1].uses, "streamfy/json-sql@0.2.1");
        assert_eq!(
