...
use streamfy_future::fs::File;
use streamfy_future::file_slice::AsyncFileSlice;
use streamfy_future::fs::BoundedFileSinkError;
use streamfy_protocol::record::Batch;
use streamfy_protocol::record::{Offset, Size, Size64};
...
impl MutFileRecords {
    ...
    pub async fn create(
        ...
        let file = streamfy_future::fs::util::open_read_append(log_path.clone()).await?;
