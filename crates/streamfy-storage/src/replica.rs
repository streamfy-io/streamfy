...
use streamfy_protocol::record::{Offset, ReplicaKey, Size, Size64};
use streamfy_protocol::record::{Batch, BatchRecords};
...
mod tests {
    ...
    use streamfy_future::fs::remove_dir_all;
    ...
    async fn test_replica_repair_bad_header() {
        ...
        let mut file = streamfy_future::fs::util::open_read_append(&test_fs_path)
            .await
