...
use streamfy_future::net::ConnectionFd;
...
impl MultiplexerSocket {
    pub fn shared(socket: StreamfySocket) -> Arc<Self> {
    ...
    pub fn new(socket: StreamfySocket) -> Self {
...
/// This decodes streamfy protocol based streams and multiplex into different slots
...
impl MultiPlexingResponseDispatcher {
    ...
    async fn dispatcher_loop(mut self, mut stream: StreamfyStream) {
...
mod tests {
    ...
    trait AcceptorHandler {
        ...
        async fn accept(&mut self, stream: TcpStream) -> StreamfySocket;
    }
    ...
    async fn test_server<A: AcceptorHandler + 'static>(
        ...
        let socket: StreamfySocket = handler.accept(incoming_stream).await;
    ...
    trait ConnectorHandler {
        ...
        async fn connect(&mut self, stream: TcpStream) -> StreamfySocket;
    }
    ...
    mod tls_test {
        ...
        impl AcceptorHandler for TlsAcceptorHandler {
            ...
            async fn accept(&mut self, stream: TcpStream) -> StreamfySocket {
                ...
                StreamfySocket::from_stream(write, read, fd)
            }
        }
