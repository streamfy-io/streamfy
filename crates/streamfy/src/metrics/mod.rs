...
pub struct ClientMetrics {
    ...
    #[cfg(feature = "smartengine")]
    smartmodules: Mutex<HashMap<String, streamfy_smartengine::metrics::SmartModuleChainMetrics>>,
}
...
impl ClientMetrics {
    ...
    pub(crate) fn metrics_append(
        &self,
        append: &HashMap<String, streamfy_smartengine::metrics::SmartModuleChainMetrics>,
    ) {
