...
use streamfy_future::retry::{ExponentialBackoff, FibonacciBackoff, FixedDelay};
...
///
/// Create a producer with a custom config with [`crate::Streamfy::topic_producer_with_config()`].
...
pub struct TopicProducerConfig {
    ...
    /// Compression algorithm used by Streamfy producer to compress data.
