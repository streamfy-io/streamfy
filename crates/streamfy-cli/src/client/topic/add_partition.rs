...
use streamfy_sc_schema::topic::{AddPartition, TopicSpec, UpdateTopicAction};
use streamfy::{Streamfy, StreamfyAdmin};
...
mod tests {
    use super::*;
    use streamfy_future::test_async;
    use streamfy::StreamfyError;

    #[test_async]
    async fn test_add_partition_display() -> Result<(), StreamfyError> {
