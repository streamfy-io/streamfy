...
mod cmd {
    ...
    use streamfy_sc_schema::topic::{MirrorConfig, PartitionMap, ReplicaSpec, TopicSpec};
    #[cfg(feature = "producer-file-io")]
    ...
    #[cfg(feature = "producer-file-io")]
    use streamfy_cli_common::user_input::{UserInputRecords, UserInputType};
    #[cfg(feature = "producer-file-io")]
    use streamfy_protocol::record::RecordData;
    #[cfg(feature = "producer-file-io")]
    use streamfy_protocol::bytes::Bytes;
    ...
    pub struct ProduceOpt {
        ...
        /// Eg. streamfy produce topic-name --smartmodule my_filter -e foo=bar -e key=value -e one=1
        #[arg(
            short = 'e',
        ...
        /// E.g. streamfy produce topic-name --transforms-line='{"uses":"streamfy/jolt@0.1.0","with":{"spec":"[{\"operation\":\"default\",\"spec\":{\"source\":\"test\"}}]"}}'
