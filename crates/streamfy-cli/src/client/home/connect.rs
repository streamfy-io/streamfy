...
use streamfy_sc_schema::mirror::{MirrorSpec, MirrorType};
use streamfy_sc_schema::remote_file::RemoteMetadataExport;
...
impl ConnectOpt {
    pub async fn execute<T: Terminal>(
        ...
        let admin = streamfy::Streamfy::connect_with_config(&streamfy_config)
            .await?
            .admin()
            .await;
