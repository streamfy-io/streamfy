...
use crate::test_runner::test_meta::StreamfyTestMeta;
use clap::{Parser, builder::PossibleValuesParser};
use std::fmt::Debug;
use std::time::Duration;
use humantime::parse_duration;
use uuid::Uuid;
use streamfy::{Compression, DeliverySemantic};
...
pub struct EnvironmentSetup {
    /// Name of the test
    #[arg(value_parser = PossibleValuesParser::new(StreamfyTestMeta::all_test_names()))]
    ...
    // log apply to streamfy client
    #[arg(long)]
    pub client_log: Option<String>,

    // log apply to streamfy
    #[arg(long)]
