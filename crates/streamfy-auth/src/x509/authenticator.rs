...
impl X509Authenticator {
    ...
    async fn send_authorization_request(
        ...
        let mut socket = streamfy_socket::StreamfySocket::from_stream(
        ...
        let ResponseMessage { response, .. } =
            socket
                ...
                .map_err(|err| match err {
                    streamfy_socket::SocketError::Io { source, .. } => source,
                    streamfy_socket::SocketError::SocketClosed
                    | streamfy_socket::SocketError::SocketStale => {
