...
pub mod errors {
    pub use streamfy_protocol::link::ErrorCode;
}

pub use streamfy_controlplane_metadata::core;
pub use streamfy_controlplane_metadata::store;
pub use streamfy_controlplane_metadata::message;
...
mod admin {
    ...
    pub trait AdminSpec: Spec + Encoder + Decoder {
        ...
        fn convert_from<C: streamfy_controlplane_metadata::core::MetadataItem>(
            obj: &streamfy_controlplane_metadata::store::MetadataStoreObject<Self, C>,
        ) -> Metadata<Self>
        where
