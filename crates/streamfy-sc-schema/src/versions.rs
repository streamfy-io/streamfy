...
//! SC supports Kafka as well as Streamfy specific APIs.
//!

pub use streamfy_protocol::link::versions::{ApiVersionKey, ApiVersions};
pub use streamfy_protocol::link::versions::{ApiVersionsRequest, ApiVersionsResponse};
