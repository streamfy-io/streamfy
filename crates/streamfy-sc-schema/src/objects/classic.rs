            ...
            paste::paste! {
                ...
                impl [<ClassicObjectApi $api>] {
                    fn type_string(&self) -> &'static str {
                        use streamfy_controlplane_metadata::core::Spec;
                        match self {
                ...
                impl  streamfy_protocol::Encoder for [<ClassicObjectApi $api>] {
                    ...
                    fn encode<T>(&self, dest: &mut T, version: streamfy_protocol::Version) -> Result<(), std::io::Error>
                    where
                        T: streamfy_protocol::bytes::BufMut,
                    {
                ...
                impl  streamfy_protocol::Decoder for [<ClassicObjectApi $api>] {

                    fn decode<T>(&mut self, src: &mut T, version: streamfy_protocol::Version) -> Result<(),std::io::Error>
                    where
                        T: streamfy_protocol::bytes::Buf
                    {
                        use streamfy_controlplane_metadata::core::Spec;
    ...
    macro_rules! ClassicDecoding {
        ...
        ($api:ident) => {
            ...
            paste::paste! {
                ...
                impl  streamfy_protocol::Decoder for [<ObjectApi $api>] {
    ...
    macro_rules! ClassicDeleteApiEnum {
        ($api:ident) => {
            ...
            paste::paste! {
                ...
                impl  streamfy_protocol::Encoder for [<ClassicDeleteApi $api>] {
                ...
                impl  streamfy_protocol::Decoder for [<ClassicDeleteApi $api>] {
...
mod create {
    ...
    use streamfy_controlplane_metadata::mirror::MirrorSpec;
    use streamfy_protocol::bytes::{BufMut, Buf};
