...
// The streamfy COMMON_VERSION in streamfy-spu-schema/src/lib.rs
...
pub enum SmartModuleKind {
    ...
    Map,
    #[streamfy(tag = 2)]
    #[streamfy(min_version = ARRAY_MAP_WASM_API)]
    ArrayMap,
    #[streamfy(tag = 3)]
    ...
    FilterMap,
    #[streamfy(tag = 5)]
    #[streamfy(min_version = SMART_MODULE_API, max_version = CHAIN_SMARTMODULE_API)]
    Join(String),
    #[streamfy(tag = 6)]
    #[streamfy(min_version = SMART_MODULE_API, max_version = CHAIN_SMARTMODULE_API)]
    JoinStream {
    ...
    #[streamfy(tag = 7)]
    #[streamfy(min_version = GENERIC_SMARTMODULE_API)]
