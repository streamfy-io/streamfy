...
use streamfy_protocol::record::RawRecords;
use streamfy_protocol::{Encoder, Decoder};
use streamfy_protocol::api::Request;
use streamfy_protocol::record::RecordSet;
use streamfy_smartmodule::dataplane::smartmodule::SmartModuleExtraParams;
use streamfy_types::{PartitionId, defaults::STREAMFY_CLIENT_MAX_FETCH_BYTES};
...
pub struct StreamFetchRequest<R> {
    ...
    #[builder(default = "STREAMFY_CLIENT_MAX_FETCH_BYTES")]
    pub max_bytes: i32,
...
mod file {
    ...
    use streamfy_protocol::store::{StoreValue, FileWrite};
