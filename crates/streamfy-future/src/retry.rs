...
pub trait RetryExt: Future {
    ...
    /// use streamfy_future::retry::TimeoutError;
    /// use std::time::{Duration, Instant};
    ///
    /// streamfy_future::task::run(async {
...
/// use std::time::Duration;
/// use streamfy_future::retry::FixedDelay;
/// use streamfy_future::retry::retry;
///
/// streamfy_future::task::run(async {
...
mod delay {
    ...
    /// ```
    /// use std::io::Error;
    /// use streamfy_future::retry::{FixedDelay, retry};
    /// use std::time::{Duration, Instant};
    ///
    /// streamfy_future::task::run(async {
    ...
    /// ```
    /// use std::io::Error;
    /// use streamfy_future::retry::{FibonacciBackoff, retry};
    /// use std::time::{Duration, Instant};
    ///
    /// streamfy_future::task::run(async {
    ...
    /// ```
    /// use std::io::Error;
    /// use streamfy_future::retry::{ExponentialBackoff, retry};
    /// use std::time::{Duration, Instant};
    ///
    /// streamfy_future::task::run(async {
