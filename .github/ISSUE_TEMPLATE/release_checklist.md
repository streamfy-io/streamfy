...
about: Process to follow for running the Streamfy release
...
For more detail, refer to [`RELEASE.md`](https://github.com/streamfy/streamfy/blob/master/RELEASE.md)

- [ ] Create a [new issue](https://github.com/streamfy/streamfy/issues/new?template=release_checklist.md) with this checklist template
- [ ] Review all the [Getting Started](https://www.streamfy.io/docs/get-started/mac/) and [API](https://www.streamfy.io/api/) docs. Verify if they are up to date or will need updates
- [ ] Inform team that release is about to begin
- [ ] Ensure no merges are in flight

## Pre-Release

- [ ] Run the [`Release` workflow in Github Actions](https://github.com/streamfy/streamfy/actions/workflows/release.yml), **make sure the `pre-release` check is set**. (Retry at least once if failure)
...
- [ ] Create a PR for release
  ...
  - [ ] Merge the PR
- [ ] Run the [`Release` workflow in Github Actions](https://github.com/streamfy/streamfy/actions/workflows/release.yml)
**without the `pre-release` check**.
- [ ] Verify that the [crates publish to crates.io](https://github.com/streamfy/streamfy/actions/workflows/publish_crates.yml) succeeds (Retry at least once if failure)
- [ ] Announce new release in Discord
- [ ] Update the [Streamfy docs](https://www.streamfy.io/) with the new release.
- [ ] Publish a `This Week in Streamfy` post about the new release on the [Streamfy news](https://www.streamfy.io/news) page.
- [ ] To close this issue, create a PR for post release updates and use `release_template.md`
  ...
  - e.g. https://github.com/streamfy/streamfy/compare/master...username:your-branch?expand=1&template=release_template.md
