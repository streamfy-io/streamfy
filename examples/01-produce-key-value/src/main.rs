...
//!
//! ```text
//! $ streamfy consume key-value -B -d
//! [Hello] Streamfy
//! ```
...
async fn produce_key_value() -> anyhow::Result<()> {
    let producer = streamfy::producer("key-value").await?;
