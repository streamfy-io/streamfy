...
CARGO_BUILDER?=cargo
STREAMFY_BIN?=$(if $(TARGET),./target/$(TARGET)/$(BUILD_PROFILE)/streamfy,./target/$(BUILD_PROFILE)/streamfy)
...
include crates/streamfy-storage/Makefile
