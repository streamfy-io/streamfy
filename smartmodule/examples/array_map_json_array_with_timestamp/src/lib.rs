...
//!
//! ```text
//! $ streamfy topic create array-map-array
//! ```
//!
//! Produce some valid JSON arrays as input:
//!
//! ```text
//! $ streamfy produce array-map-array
...
//! $ cargo build --release
//! $ streamfy consume array-map-array -B --array-map=target/wasm32-wasip1/release/streamfy_wasm_array_map_array.wasm
//! "Apple"
//! "Banana"
//! "Cranberry"
//! ```
