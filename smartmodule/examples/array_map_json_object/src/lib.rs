...
//!
//! ```text
//! $ streamfy topic create array-map-object
//! ```
//!
//! Produce some valid JSON objects as input:
//!
//! ```text
//! $ streamfy produce array-map-object
...
//! $ cargo build --release
//! $ streamfy consume array-map-object -B --key-value --array-map=target/wasm32-wasip1/release/streamfy_wasm_array_map_object.wasm
//! [a] "Apple"
//! [b] "Banana"
//! [c] "Cranberry"
//! ```
