...
//!
//! ```text
//! $ streamfy topic create application-logs
//! ```
//!
...
//!
//! ```text
//! $ streamfy consume application-logs -B
...
//!
//! ```text
//! $ cargo build --release -p streamfy-smartmodule-filter-json
//! $ streamfy consume application-logs -B --smart-stream=target/wasm32-wasip1/release/streamfy-smartmodule-filter-json.wasm
//! {"level":"info","message":"Server listening on 0.0.0.0:8000"}
//! {"level":"info","message":"Accepted incoming connection"}
//! {"level":"warn","message":"Client dropped connection}
//! {"level":"info","message":"Accepted incoming connection"}
