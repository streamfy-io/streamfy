...
use streamfy_smartmodule::dataplane::smartmodule::{SmartModuleExtraParams{% if smartmodule-type == "filter" %}, SmartModuleInitError{% endif %}};
{% if smartmodule-type == "filter" %}
use std::sync::OnceLock;
use streamfy_smartmodule::eyre;
{% endif %}
{% endif %}
{% if smartmodule-type == "filter" %}
use streamfy_smartmodule::{smartmodule, Result, SmartModuleRecord};
...
fn init(params: SmartModuleExtraParams) -> Result<()> {
    // You can refer to the example SmartModules in Streamfy's GitHub Repository
    // https://github.com/streamfy/streamfy/tree/master/smartmodule
