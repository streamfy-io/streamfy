...
#
# This dockerfile creates a container of development dependencies for Streamfy smartmodules
...
#   a user usually will run "cargo generate gh:streamfy/streamfy-smartmodule-template" and provide inputs
...
RUN source "$HOME/.cargo/env" && \
	cargo generate gh:streamfy/streamfy-smartmodule-template --name example-sm --template-values-file tmpl-in
